...
const ImagePath ="url(/media/face.webp)";
const Image = [
...
let st;
const soundsEffect =[
    {path:'/media/zelda_navi_listen.mp3'},
    {path:'/media/zelda_secret.mp3'},
    {path:'/media/pokemon_snap_wrong.mp3'},
    {path:'/media/zelda_win.mp3'}
];
